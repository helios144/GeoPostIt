  ...
  <head>
   ...
   /* if(isset($_GET['title'])){
    ...
    <script src="/toastmsg.js"></script> 
             <script>
      /* if get not empty open marker
        if coordinates unknown window doesnt exist
        edit url based on opened ifnowindow
       */
...
$(document).on('click','#btn-new-post',(event)=>{
  toast({
    position:'middle',
    loadingSpinner:true,
    id:"post-spinner",
